...
function parsingPacket(pktmessage)
{
  ...
  {
  user_count++;
  usertable[hashCode] = user_count;
  currentUser = user_count;
  createNewRow(BLE_address,0);
  }
  else
  {
  currentUser = usertable[hashCode];
...
function createNewRow(str1,str2)
{
          var row = table.insertRow(table.length); 
		  ...
		  cell0.style.width="10%" ;
		  cell0.style.fontSize="8pt";
          cell0.innerHTML = str1;
		  
		  var cell1 = row.insertCell(1);
		  cell1.style.width="10%" ;
		  cell1.style.fontSize="8pt";
		  cell1.innerHTML = str2;
}

function updateUserinfo(userID,stat)
{
          var row = table[userID];
